...
public class AVGCounter {
	...
	public AVGCounter(JobCounter jobCounter){
		this.setName(jobCounter.getName());
		this.setMapNum(jobCounter.getMapNum());
		this.setReduceNum(jobCounter.getReduceNum());
		this.setJobRankNum(jobCounter.getJobRankNum());
		this.setMapCPUTime(jobCounter.getMapCPUTime());
		this.setReduceCPUTime(jobCounter.getReduceCPUTime());
		this.setMapElapsedTime(jobCounter.getMapElapsedTime());
		this.setReduceElapsedTime(jobCounter.getReduceElapsedTime());
		this.setShuffleBytes(jobCounter.getShuffleBytes());
		this.setShufflePhaseTime(jobCounter.getShufflePhaseTime());
		this.setSortPhaseTime(jobCounter.getSortPhaseTime());
		this.setReducePhaseTime(jobCounter.getReducePhaseTime());
		this.setTotalCPUTime(jobCounter.getTotalCPUTime());
	}
